...
import { History, Search, Download, Filter, Calendar, Bug, AlertCircle, TrendingUp, ChevronRight, Activity } from "lucide-react";
import { API_URL } from "../config";

export default function RiwayatGrafik() {
    ...
    // Data untuk Bar Chart (15 data terbaru)
    ...
    // Data untuk Tren Hama (Grup per hari dalam seminggu terakhir)
    const getWeeklyTrend = () => {
        ...
        return Object.entries(dailyMap).map(([date, total]) => ({ date, total })).slice(-7);
    };
        ...
        return (
            <div className="flex justify-center items-center h-64">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-slate-400 font-bold animate-pulse">Memuat riwayat & grafik...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-4 lg:space-y-10 animate-in slide-in-from-bottom-5 duration-700">
            ...
            <div className="bg-gradient-to-r from-slate-900 to-indigo-900 rounded-2xl lg:rounded-[3.5rem] p-6 lg:p-14 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4 lg:gap-8">
                    ...
                    <div className="text-center md:text-left">
                        <h2 className="text-xl lg:text-5xl font-black tracking-tight leading-none mb-2">Riwayat & Grafik</h2>
                        <p className="text-slate-300 max-w-2xl font-bold text-[10px] lg:text-xl leading-relaxed">
                            Catatan hama yang pernah muncul di sawah Anda.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12">
                {/* Trend Area Chart - Bigger labels */}
                ...
                {/* Frequency Bar Chart - Bigger bars/labels */}
                <div className="bg-white p-5 lg:p-10 rounded-2xl lg:rounded-[2.5rem] border border-slate-100 shadow-xl">
                    <div className="flex items-center justify-between mb-6 lg:mb-10">
                        <div>
            ...
            {/* Full History Table - Large text and better padding */}
